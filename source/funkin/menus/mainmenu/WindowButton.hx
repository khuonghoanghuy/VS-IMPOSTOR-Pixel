...
class WindowButton extends FlxTypedSpriteGroup<FlxSprite>
{
	...
	public function new(x:Float = 0, y:Float = 0, data:WindowGraphicData)
	{
		...
		if (this.data.idleColor != null)
		{
			_idleColor = this.data.idleColor;
		}
		if (this.data.hoverColor != null)
		{
			_hoverColor = this.data.hoverColor;
		}
	...
	public function checkPosition(position:FlxPoint)
	{
