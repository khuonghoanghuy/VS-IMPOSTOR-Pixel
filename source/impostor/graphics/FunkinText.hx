...
class FunkinText extends FlxText
{
	 ...
	 * 
	 * @param parameters The parameters you want the format to modify a `FunkinText`.
	 */
	 ...
	 */
	public function new(x:Float = 0, y:Float = 0, fieldWidth:Float = 0, text:String = "", size:Int = 12, useBorders:Bool = true)
	{
